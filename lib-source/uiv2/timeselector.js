    ...
    render = () => {
        ...
        return (
            <div>
                ...
                <RangeInput key="0" value={hours} min={0} max={23} label="Hour" onChange={this.change('hours')} focusStyle={{backgroundColor: 'cyan'}} />
                <RangeInput key="1" value={minutes} min={0} max={59} label="Minute" onChange={this.change('minutes')} />
            </div>
        );
    }
}
