    ...
    var dialog = (function () {
        ...
        */
        ...
        function beginMove(event, instance) {
            if (resizable === null && !instance.isMaximized() && instance.get('movable')) {
                ...
                if (event.type === 'touchstart') {
                    event.preventDefault();
                    eventSrc = event.changedTouches[0];
                    xProp = 'clientX';
                    yProp = 'clientY';
        ...
        function bindEvents(instance) {
            ...
            // common events
            on(instance.elements.commands.container, 'tap', instance.__internal.commandsClickHandler);
            on(instance.elements.footer, 'tap', instance.__internal.buttonsClickHandler);
        ...
        function unbindEvents(instance) {
            ...
            // common events
            off(instance.elements.commands.container, 'tap', instance.__internal.commandsClickHandler);
            off(instance.elements.footer, 'tap', instance.__internal.buttonsClickHandler);
        ...
        function bindClosableEvents(instance) {
            on(instance.elements.modal, 'tap', instance.__internal.modalClickHandler);
        }
        ...
        function unbindClosableEvents(instance) {
            off(instance.elements.modal, 'tap', instance.__internal.modalClickHandler);
        }
        // dialog API
        return {
            __init:initialize,
            ...
            return initialize({
                ...
                push: function (_content, _wait) {
                    if (!this.__internal.pushed) {
                        ...
                        // attach click event
                        on(this.element, 'tap', this.__internal.clickHandler);
                ...
                dismiss: function (clicked) {
                    if (this.__internal.pushed) {
                        ...
                        if (!(typeof this.ondismiss === 'function' && this.ondismiss.call(this) === false)) {
                            //detach click event
                            off(this.element, 'tap', this.__internal.clickHandler);
