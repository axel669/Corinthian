...
fc = (function () {
    ...
    (function () {
        ...
        messageListener.addEventListener("message", messageCallback, false);
        ...
        callbackWrapper = function (callback, nextPromise) {
            return function (value) {
                ...
                try {
                    ...
                    if (typeof retValue === 'object' && retValue.hasOwnProperty('then') === true && (typeof retValue.then) === 'function') {
                        retValue.then(
