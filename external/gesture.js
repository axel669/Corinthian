...
var gesture = (function () {
    "use strict";
    var TouchData, angle, angleDif, sq, mag, forEach,
        gestureCallbacks, keys, gesture,
        touchStartPosition, touchLastPosition, touchVars,
        enabled;
    ...
    window.addEventListener(
        ...
        function (evt) {
            ...
            forEach(
                evt.changedTouches,
                function (touch) {
                    var touchData, startPos, lastPos, dif;
