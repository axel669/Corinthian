...
module.exports = function () {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
      ...
      return module;
    }, "function", { type: "literal", value: "function", description: "\"function\"" }, function (type, name, props) {
    ...
    }, "@", { type: "literal", value: "@", description: "\"@\"" }, /^[a-zA-Z_]/, { type: "class", value: "[a-zA-Z_]", description: "[a-zA-Z_]" }, function (type, name, params) {
      ...
      return [first].concat(_toConsumableArray(rest));
        ...
        peg$bytecode = [peg$decode("%;1/^#$%;!/,#;1/#$+\")(\"'#&'#06*%;!/,#;1/#$+\")(\"'#&'#&/($8\": \"! )(\"'#&'#"), peg$decode("%;1/\xBC#2!\"\"6!7\"/\xAD$;1/\xA4$;0/\x9B$;1/\x92$2#\"\"6#7$/\x83$;1/z$$%;\".# &;&/,#;1/#$+\")(\"'#&'#0<*%;\".# &;&/,#;1/#$+\")(\"'#&'#&/8$2%\"\"6%7&/)$8):')\"%!)()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"), peg$decode("%2(\"\"6(7)/\xAE#;1/\xA5$;0/\x9C$;1/\x93$2#\"\"6#7$/\x84$;1/{$$%;#.# &;+/,#;1/#$+\")(\"'#&'#0<*%;#.# &;+/,#;1/#$+\")(\"'#&'#&/9$2%\"\"6%7&/*$8(:*(#'%!)(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"), peg$decode("%2+\"\"6+7,/:#;1/1$;$/($8#:-#! )(#'#(\"'#&'#"), peg$decode("%2#\"\"6#7$/v#;1/m$$%;%/,#;1/#$+\")(\"'#&'#06*%;%/,#;1/#$+\")(\"'#&'#&/7$2%\"\"6%7&/($8$:.$!!)($'#(#'#(\"'#&'#"), peg$decode("%2/\"\"6/70/\xB1#21\"\"6172.\" &\"/\x9D$;1/\x94$;0/\x8B$%;1/J#23\"\"6374/;$;./2$25\"\"6576/#$+$)($'#(#'#(\"'#&'#.\" &\"/L$%;1/,#;-/#$+\")(\"'#&'#.\" &\"/+$8&:7&$$\"! )(&'#(%'#($'#(#'#(\"'#&'#"), peg$decode("%%$48\"\"5!79/,#0)*48\"\"5!79&&&#/\"!&,)/N#;1/E$;0/<$;1/3$;(/*$8%::%#$\" )(%'#($'#(#'#(\"'#&'#"), peg$decode("%2;\"\"6;7</}#;1/t$;0/k$;1/b$2#\"\"6#7$/S$;1/J$;)/A$;1/8$2%\"\"6%7&/)$8):=)\"&\")()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"), peg$decode("%2#\"\"6#7$/\x82#;1/y$$%;\".# &;)/,#;1/#$+\")(\"'#&'#0<*%;\".# &;)/,#;1/#$+\")(\"'#&'#&/7$2%\"\"6%7&/($8$:>$!!)($'#(#'#(\"'#&'#"), peg$decode("%2?\"\"6?7@/|#%$4A\"\"5!7B/,#0)*4A\"\"5!7B&&&#/\"!&,)/S$;1/J$;0.\" &\"/<$;1/3$;*/*$8&:C&#$\" )(&'#(%'#($'#(#'#(\"'#&'#"), peg$decode("%2#\"\"6#7$/v#;1/m$$%;+/,#;1/#$+\")(\"'#&'#06*%;+/,#;1/#$+\")(\"'#&'#&/7$2%\"\"6%7&/($8$:D$!!)($'#(#'#(\"'#&'#"), peg$decode("%2?\"\"6?7@/S#;0/J$%;1/,#;-/#$+\")(\"'#&'#.\" &\"/)$8#:E#\"! )(#'#(\"'#&'#"), peg$decode("%%2#\"\"6#7$/;#;-/2$2%\"\"6%7&/#$+#)(#'#(\"'#&'#/\"!&,).R &%%2#\"\"6#7$/;#;1/2$2%\"\"6%7&/#$+#)(#'#(\"'#&'#/\"!&,)"), peg$decode("%%%;//e#$%;1/2#;/.# &;,/#$+\")(\"'#&'#0<*%;1/2#;/.# &;,/#$+\")(\"'#&'#&/#$+\")(\"'#&'#/\"!&,)/' 8!:F!! )"), peg$decode("%;0/b#%;1/D#2G\"\"6G7H/5$;1/,$;./#$+$)($'#(#'#(\"'#&'#.\" &\"/)$8\":I\"\"! )(\"'#&'#"), peg$decode("%$4J\"\"5!7K/,#0)*4J\"\"5!7K&&&#/\"!&,)"), peg$decode("%$4A\"\"5!7B/,#0)*4A\"\"5!7B&&&#/\"!&,)"), peg$decode("<$4M\"\"5!7N0)*4M\"\"5!7N&=.\" 7L")],
        peg$currPos = 0,
        peg$savedPos = 0,
