            ...
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    ...
                    return _regeneratorRuntime.awrap(Zip.download("https://axel669.ngrok.io/app-base.zip", function (evt) {
                        return _this.setState({ progress: evt.loaded / evt.total });
                    }));
                ...
                case 5:
                    ...
                    return _regeneratorRuntime.awrap(zip.extractTo("app::/app_files_temp/", function (evt) {
                        return _this.setState({ fileProgress: [evt.extracted, evt.total] });
                    }));

                case 7:
                    context$1$0.t0 = console;
                    context$1$0.next = 10;
                    return _regeneratorRuntime.awrap(fs.dirTree("app::/"));
                ...
                case 20:
                    context$1$0.t3 = console;
                    context$1$0.next = 23;
                    return _regeneratorRuntime.awrap(fs.dirTree("app::/"));

                case 23:
                    context$1$0.t4 = context$1$0.sent;
                    context$1$0.t3.log.call(context$1$0.t3, context$1$0.t4);
