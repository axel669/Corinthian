...
var baseURL = "https://axel669.ngrok.io/";
var appDirectory = "app::/app_files/";
var tempAppDirectory = "app::/app_files_temp/";
...
var states = {
    versionCheck: React.createClass({
        ...
        componentDidMount: function componentDidMount() {
            ...
            schedule(3000, function () {
                return _this.props.transition("update");
            });
        },
    ...
    update: React.createClass({
        ...
        componentDidMount: function componentDidMount() {
            var transition, zip;
            return _regeneratorRuntime.async(function componentDidMount$(context$1$0) {
                var _this2 = this;
                ...
                while (1) switch (context$1$0.prev = context$1$0.next) {
                    case 0:
                        ...
                        context$1$0.next = 3;
                        return _regeneratorRuntime.awrap(Zip.download("https://axel669.ngrok.io/app-base.zip", function (evt) {
                            return _this2.setState({ progress: evt.loaded / evt.total });
                        }));

                    case 3:
                        zip = context$1$0.sent;
                        context$1$0.next = 6;
                        return _regeneratorRuntime.awrap(fs.dirCreate("app::/app_files_temp/"));

                    case 6:
                        context$1$0.next = 8;
                        return _regeneratorRuntime.awrap(zip.extractTo("app::/app_files_temp/", function (evt) {
                            return _this2.setState({ fileProgress: [evt.extracted, evt.total] });
                        }));

                    case 8:
                        context$1$0.next = 10;
                        return _regeneratorRuntime.awrap(fs.dirExists("app::/app_files/"));
                    ...
                    case 10:
                        ...
                        context$1$0.next = 14;
                        return _regeneratorRuntime.awrap(fs.dirRemove("app::/app_files/", true));

                    case 14:
                        context$1$0.next = 16;
                        return _regeneratorRuntime.awrap(fs.dirMove("app::/app_files_temp/", "app::/app_files/"));
        ...
        render: function render() {
            ...
            var fileProgress = _state.fileProgress;
            ...
            return React.createElement(
                ...
                null,
                progressText,
                React.createElement(UI.ProgressBar, { progress: progress })
            );
        }
    }),
        ...
        componentDidMount: function componentDidMount() {
            ...
            return _regeneratorRuntime.async(function componentDidMount$(context$1$0) {
                while (1) switch (context$1$0.prev = context$1$0.next) {
                    case 0:
                        context$1$0.next = 2;
                        return _regeneratorRuntime.awrap(fs.fileRead("app::/app_files/app.js"));

                    case 2:
                        appCode = context$1$0.sent;
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Element, { transition: this.transition })
                )
            )
        );
    }
...
var DialogTest = React.createClass({
    ...
    dialogTest: function dialogTest(type) {
        var _this3 = this;
                ...
                while (1) switch (context$2$0.prev = context$2$0.next) {
                    case 0:
                        ...
                        return _regeneratorRuntime.awrap((function () {
                            switch (type) {
                                case 'alert':
                                    return Dialog.alert(factotum.range(100, function (n) {
                                        return React.createElement(
                                            "div",
                                            null,
                                            n
                                ...
                                case 'confirm':
                                    return Dialog.confirm("Confirm Test?");
                                case 'prompt':
                                    return Dialog.prompt("Enter your hogwarts house");
                            }
                        })());
    ...
    spinnerTest: function spinnerTest() {
        var spinner = Dialog.spinner("Loading");
        schedule(2000, function () {
            return spinner.dismiss();
        });
    },
    customTest: function customTest() {
        var value;
        return _regeneratorRuntime.async(function customTest$(context$1$0) {
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    context$1$0.next = 2;
                    return _regeneratorRuntime.awrap(Dialog.__custom(function (close) {
                        return {
                            content: "This is a test",
                            buttons: [{ text: "Test", width: '50%' }, { text: "Nope", value: 100, width: '50%' }],
                            title: "Wat"
                        };
                    }));
    ...
    render: function render() {
        ...
        return React.createElement(
            UI.Screen,
            { title: "Dialog Test" },
            React.createElement(UI.Button, { text: "Fuck", onTap: function () {
                    return App.navigation.push("/test");
                } }),
            React.createElement(
                UI.Form,
                { submitText: "Test", itemContainer: UI.Card, onSubmit: function (_ref) {
                        var wat = _ref.wat;
                        return cblog(wat);
                    } },
                React.createElement(UI.Item, { inputType: "multiline", name: "wat", placeholder: "Testing", label: "Wat", height: "4l" })
            )
        );
    }
});
...
// };
var called = false;
var waitComponent = function waitComponent(location, cb) {
    return _regeneratorRuntime.async(function waitComponent$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            case 0:
                console.log('load c');
                ...
                context$1$0.next = 4;
                return _regeneratorRuntime.awrap(chrono.wait(1000));
...
var waitIndex = function waitIndex(location, cb) {
    return _regeneratorRuntime.async(function waitIndex$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            case 0:
            ...
            case 3:
                cb(null, [React.createElement(Route, { path: "/", component: Test }), React.createElement(Route, { path: "/test", component: Wat })]);
...
App.start(React.createElement(
    Route,
    null,
    React.createElement(Route, { path: "/blah", component: DialogTest }),
    React.createElement(Route, { getChildRoutes: waitIndex })
));
