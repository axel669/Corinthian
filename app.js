...
var Main = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            UI.Screen,
            { title: 'Testing', subtext: 'WOAH', width: 700 },
            React.createElement(UI.Button, { block: true, raised: true, text: 'Dialog', onTap: this.testAlert }),
            React.createElement(
                UI.RadioGroup,
                { selectedIndex: 0 },
                React.createElement(
            ...
            React.createElement(
                UI.RadioGroup,
                { selectedIndex: selectedIndex, onChange: this.updateSetting('selectedIndex'), layout: 'grid', height: 40, rowCount: 1, colCount: 3, label: 'Horizontal Test' },
                React.createElement(
                    UI.Option,
                    null,
                    'First'
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(UI.Item, { inputType: 'text', name: 'blah' }),
                    React.createElement(UI.Item, { inputType: 'text', name: 'woah' }),
                    React.createElement(
                        UI.Item,
                        { name: 'radio', inputType: 'radio', layout: 'grid', height: 40, rowCount: 1, colCount: 3, label: 'Horizontal Test', defaultIndex: -1 },
                        React.createElement(
                            UI.Option,
                            { value: 100 },
                            'First'
