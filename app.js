...
var Main = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            UI.Screen,
            { title: "Test", backText: "test", width: 600, onBack: this.demo, scrollable: true },
            React.createElement(
                UI.Card,
                { titleColor: "#444", titleTextColor: "white", title: "Test" },
                "Content"
            ),
            React.createElement(UI.Button, { block: true, text: "Test" }),
            React.createElement(UI.Button, { text: "Test" }),
            React.createElement(UI.Button.Raised, { text: "test", onTap: wat }),
            React.createElement(UI.Input.Range, { min: 0, max: 100, value: this.state.rangeValue, onChange: function (rangeValue) {
                    return _this.setState({ rangeValue: rangeValue });
                } }),
            React.createElement(UI.ProgressBar, { progress: this.state.rangeValue / 100 }),
            React.createElement(
                UI.Form,
                null,
                React.createElement(UI.Toggle, { formName: "toggle", label: "Test" }),
                React.createElement(UI.Input.Time, { formName: "time", format: "{hour/12padded} - {minute} - {second}" }),
                React.createElement(UI.Input.Date, { formName: "date" }),
                React.createElement(UI.Input.Text, { formName: "text" }),
                React.createElement(UI.Input.Password, { formName: "pw" }),
                React.createElement(UI.Input.Search, { formName: "search" }),
                React.createElement(UI.Input.URL, { formName: "url" }),
                React.createElement(UI.Input.Range, { min: 0, max: 100 }),
                React.createElement(
                    UI.Radio,
                    { formName: "radio" },
                    arange(10, function (n) {
                        return React.createElement(
                            UI.Option,
                            { value: Math.pow(n, 2) },
                            n
