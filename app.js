...
exports.__esModule = true;
},{"babel-runtime/core-js/object/assign":2}],10:[function(require,module,exports){
"use strict";
...
exports.__esModule = true;
},{"babel-runtime/core-js/object/create":3,"babel-runtime/core-js/object/set-prototype-of":5}],11:[function(require,module,exports){
(function (global){
...
},{"_process":85,"babel-runtime/core-js/object/create":3,"babel-runtime/core-js/object/set-prototype-of":5,"babel-runtime/core-js/promise":6,"babel-runtime/core-js/symbol":7}],13:[function(require,module,exports){
require('../modules/web.dom.iterable');
require('../modules/es6.string.iterator');
module.exports = require('../modules/core.get-iterator');
},{"../modules/core.get-iterator":75,"../modules/es6.string.iterator":81,"../modules/web.dom.iterable":84}],14:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/$.core').Object.assign;
},{"../../modules/$.core":25,"../../modules/es6.object.assign":77}],15:[function(require,module,exports){
var $ = require('../../modules/$');
...
},{"../../modules/$.core":25,"../../modules/es7.object.entries":83}],17:[function(require,module,exports){
require('../../modules/es6.object.set-prototype-of');
module.exports = require('../../modules/$.core').Object.setPrototypeOf;
},{"../../modules/$.core":25,"../../modules/es6.object.set-prototype-of":78}],18:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/es6.string.iterator');
require('../modules/web.dom.iterable');
require('../modules/es6.promise');
module.exports = require('../modules/$.core').Promise;
},{"../modules/$.core":25,"../modules/es6.object.to-string":79,"../modules/es6.promise":80,"../modules/es6.string.iterator":81,"../modules/web.dom.iterable":84}],19:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
module.exports = require('../../modules/$.core').Symbol;
},{"../../modules/$.core":25,"../../modules/es6.object.to-string":79,"../../modules/es6.symbol":82}],20:[function(require,module,exports){
...
},{"./$.cof":24,"./$.wks":73}],24:[function(require,module,exports){
...
},{"./$.an-object":22,"./$.ctx":26,"./$.is-array-iter":41,"./$.iter-call":44,"./$.to-length":70,"./core.get-iterator-method":74}],34:[function(require,module,exports){
...
},{"./$":50,"./$.descriptors":28,"./$.property-desc":56}],38:[function(require,module,exports){
...
},{"./$.iterators":49,"./$.wks":73}],42:[function(require,module,exports){
...
},{"./$":50,"./$.hide":37,"./$.property-desc":56,"./$.set-to-string-tag":62,"./$.wks":73}],46:[function(require,module,exports){
'use strict';
...
},{"./$":50,"./$.export":31,"./$.has":36,"./$.hide":37,"./$.iter-create":45,"./$.iterators":49,"./$.library":52,"./$.redefine":58,"./$.set-to-string-tag":62,"./$.wks":73}],47:[function(require,module,exports){
...
},{"./$.wks":73}],48:[function(require,module,exports){
...
},{"./$.cof":24,"./$.global":35,"./$.task":67}],54:[function(require,module,exports){
...
},{"./$":50,"./$.fails":32,"./$.iobject":40,"./$.to-object":71}],55:[function(require,module,exports){
var $         = require('./$')
  , toIObject = require('./$.to-iobject')
  , isEnum    = $.isEnum;
...
},{"./$":50,"./$.to-iobject":69}],56:[function(require,module,exports){
...
},{"./$.hide":37}],59:[function(require,module,exports){
// 7.2.9 SameValue(x, y)
...
},{"./$":50,"./$.an-object":22,"./$.ctx":26,"./$.is-object":43}],61:[function(require,module,exports){
'use strict';
...
},{"./$":50,"./$.core":25,"./$.descriptors":28,"./$.wks":73}],62:[function(require,module,exports){
...
},{"./$":50,"./$.has":36,"./$.wks":73}],63:[function(require,module,exports){
var global = require('./$.global')
...
},{"./$.a-function":20,"./$.an-object":22,"./$.wks":73}],65:[function(require,module,exports){
...
},{"./$.defined":27,"./$.to-integer":68}],67:[function(require,module,exports){
var ctx                = require('./$.ctx')
...
},{"./$.cof":24,"./$.ctx":26,"./$.dom-create":29,"./$.global":35,"./$.html":38,"./$.invoke":39}],68:[function(require,module,exports){
// 7.1.4 ToInteger
var ceil  = Math.ceil
  , floor = Math.floor;
module.exports = function(it){
...
},{"./$.defined":27,"./$.iobject":40}],70:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./$.to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./$.defined":27}],72:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.global":35,"./$.shared":63,"./$.uid":72}],74:[function(require,module,exports){
...
},{"./$.classof":23,"./$.core":25,"./$.iterators":49,"./$.wks":73}],75:[function(require,module,exports){
var anObject = require('./$.an-object')
...
},{"./$.an-object":22,"./$.core":25,"./core.get-iterator-method":74}],76:[function(require,module,exports){
'use strict';
...
},{"./$.add-to-unscopables":21,"./$.iter-define":46,"./$.iter-step":48,"./$.iterators":49,"./$.to-iobject":69}],77:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./$.export');

$export($export.S + $export.F, 'Object', {assign: require('./$.object-assign')});
},{"./$.export":31,"./$.object-assign":54}],78:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./$.export');
$export($export.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.export":31,"./$.set-proto":60}],79:[function(require,module,exports){
...
},{"./$.iter-define":46,"./$.string-at":66}],82:[function(require,module,exports){
'use strict';
...
},{"./$":50,"./$.an-object":22,"./$.descriptors":28,"./$.enum-keys":30,"./$.export":31,"./$.fails":32,"./$.get-names":34,"./$.global":35,"./$.has":36,"./$.is-array":42,"./$.keyof":51,"./$.library":52,"./$.property-desc":56,"./$.redefine":58,"./$.set-to-string-tag":62,"./$.shared":63,"./$.to-iobject":69,"./$.uid":72,"./$.wks":73}],83:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $export  = require('./$.export')
...
},{"./$.export":31,"./$.object-to-array":55}],84:[function(require,module,exports){
require('./es6.array.iterator');
var Iterators = require('./$.iterators');
Iterators.NodeList = Iterators.HTMLCollection = Iterators.Array;
},{"./$.iterators":49,"./es6.array.iterator":76}],85:[function(require,module,exports){
...
var BetterForm = (function (_React$Component2) {
    _inherits(BetterForm, _React$Component2);
    ...
    function BetterForm(props) {
        ...
        this.submit = function (evt) {
            ...
            console.log(_this2.internalState);
        };
        ...
        this.render = function () {
            ...
            return React.createElement(
                ...
                React.createElement(UI.Button, { text: 'Submit', onTap: _this2.submit, raised: true, block: true })
            );
        };
        ...
        if (layout === null) {
            ...
            ElemContainer = layout.FormContainer || function (_ref4) {
                var children = _ref4.children;
                return children;
            };
            this.containerProps = _Object$entries(props).reduce(function (props, _ref5) {
                var key = _ref5[0];
                var value = _ref5[1];
        ...
        this.childList = children.map(function (child, index) {
            ...
            var containerProps = _Object$entries(child.props).reduce(function (props, _ref6) {
                var key = _ref6[0];
                var value = _ref6[1];
...
var Main = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                BetterForm,
                { layout: UI.Flexbox, 'layout-colCount': 3, 'layout-autopad': true },
                factotum.range(13, function (n) {
                    return React.createElement(UI.TextInput, { formName: 'input' + n, label: n });
                })
            )
        );
    }
