...
var DialogTest = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            UI.Screen,
            { title: "Dialog Test" },
            React.createElement(UI.Button, { raised: true, block: true, text: "Alert", onTap: function () {
